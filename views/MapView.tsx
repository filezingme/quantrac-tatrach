  ...
  useEffect(() => {
    ...
    stations.forEach(st => {
      ...
      L.marker([st.lat, st.lng], { icon: stationIcon })
        .addTo(map)
        .bindPopup(`
           <div style="text-align: center; font-family: 'Inter', sans-serif; padding: 5px;">
              <h4 style="margin: 0 0 6px 0; color: #0f172a; font-size: 13px; font-weight: 700;">Trạm ${st.name}</h4>
              <div style="font-size: 12px; color: #334155; background: #f0f9ff; padding: 4px 8px; border-radius: 4px; display: inline-block;">
