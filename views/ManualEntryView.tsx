...
export const ManualEntryView: React.FC = () => {
  ...
  // Standard input class for data entry - updated to normal weight and lighter color
  const inputClass = "w-full border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none font-normal text-slate-600 dark:text-slate-300 bg-slate-50/50 dark:bg-slate-700/50 focus:bg-white dark:focus:bg-slate-700 focus:text-slate-900 dark:focus:text-white transition-colors";
